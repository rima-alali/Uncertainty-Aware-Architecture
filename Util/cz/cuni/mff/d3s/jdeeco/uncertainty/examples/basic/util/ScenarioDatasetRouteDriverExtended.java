...
public class ScenarioDatasetRouteDriverExtended {
	...
	public ScenarioDatasetRouteDriverExtended() {
		driverBehaviour();
		torques();
		routeSlops();
	}
...
//	}
	...
	public void driverBehaviour(){
		...
		driverSpeed.put(1750.0, 130.0);
		driverSpeed.put(1800.0, 170.0);
		driverSpeed.put(1850.0, 130.0);
		...
		driverSpeed.put(6550.0, 130.0);
		driverSpeed.put(6600.0, 170.0);
		driverSpeed.put(6650.0, 130.0);
	...
	public void routeSlops(){
		...
		routeSlops.put(1350.0, Math.PI/4); //Math.PI/36
		routeSlops.put(1400.0, -Math.PI/4);
		...
		routeSlops.put(3350.0, Math.PI/4);
		...
		routeSlops.put(3700.0, -Math.PI/4);
		...
		routeSlops.put(4750.0, Math.PI/4);
		...
		routeSlops.put(5100.0, -Math.PI/4);
		...
		routeSlops.put(5450.0, Math.PI/4);
		...
		routeSlops.put(5800.0, -Math.PI/4);
		...
		routeSlops.put(6500.0, Math.PI/4);
		routeSlops.put(6550.0, -Math.PI/4);
		routeSlops.put(6600.0, Math.PI/4);
		routeSlops.put(6650.0, -Math.PI/4);
