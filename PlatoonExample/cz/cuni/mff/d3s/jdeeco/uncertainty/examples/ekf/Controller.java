...
public class Controller implements Serializable{
	...
	private void setPIDKnowledge() {
		...
		pidSpeed = new MiniPID(0.04, 0.0, 0.0);
		
//		pidPos = new MiniPID(0.03, 0.0, 0.0);
//		pidSpeed = new MiniPID(0.03, 0.0, 0.0); //0.039
		
//		pidPos = new MiniPID(0.04, 0.0, 0.021);
//		pidSpeed = new MiniPID(0.04, 0.0, 0.0); //0.039
//	
			
//		pidPos = new MiniPID(0.2, 0.0, 0.0); //0.075 - 0.039 -0.037
//		pidSpeed = new MiniPID(0.1, 0.0, 0.0);//0.02
		//good everything the diff in b is less than zero a bit witout delete
//		pidPos = new MiniPID(0.04, 0.0, 0.025);
//		pidSpeed = new MiniPID(0.039, 0.0, 0.0);
//		pidPos = new MiniPID(0.04, 0.0, 0.3512);
//		pidSpeed = new MiniPID(0.038, 0.0, 0.0395);
//		pidPos = new MiniPID(0.0, 0.0, 0.0);
//		pidSpeed = new MiniPID(0.01, 0.0, 0.0);
