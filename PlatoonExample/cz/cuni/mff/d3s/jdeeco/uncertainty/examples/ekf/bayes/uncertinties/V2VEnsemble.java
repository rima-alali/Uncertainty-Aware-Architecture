...
public class V2VEnsemble {
	...
	@KnowledgeExchange
	public static void map(@In("coord.lid") String lid,
			@InOut("coord.refPos") ParamHolder<State> refPos,
			@InOut("coord.refSpeed") ParamHolder<State> refSpeed, 
			@InOut("coord.refAccel") ParamHolder<State> refAccel,
